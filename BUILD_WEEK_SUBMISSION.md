...
David started creating RunFormance from scratch on Friday, July 17, 2026, during OpenAI Build Week (July 13–21, 2026). The original conversation envisioned bringing together sources such as Apple Health, Garmin Connect, and Strava to maximize workout benefits; support cross-training and customizable race plans; and optionally use location, weather, air quality, and rapidly changing wildfire-smoke conditions to recommend when and whether to train indoors or outdoors. This was the product concept at the project’s origin, not a claim that all of those integrations and adaptive capabilities were already implemented on July 17.

The initial Build Week prototype subsequently established the product interface: Today, Plan, Coach, Connections, a beta waitlist, and feedback functionality. Commit `7a49b3e` records an early Build Week prototype checkpoint before the GPT-5.6 Adaptive Decision Engine was implemented. The July 17 concept became the foundation for that later Adaptive Decision Engine work.
